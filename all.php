			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#" onclick="gallery()">GALLERY And BUY PAINTINGS</a></li>
			...
			<div class="row">
				<div class="col-md-4 pull-left">
					<table>
						<tr align="center">
							<td>
								<br><p class="text-center"><strong>Modern Art</strong></p>
							</td>
							<tr align="center">
								<td>
				...
				<div class="col-md-4 pull-right">
					<table>
						<tr align="center">
							<td>
								<br><p class="text-center"><strong>Acrylic Abstract</strong></p>
							</td>
						</tr>
						<tr align="center">
							<td>
				...
				<div class="col-md-4 center-block">
					<table width="100%">
						<tr align="center">
							<td>
								<br><p class="text-center"><strong>Landscapes/ Cityscapes</strong></p>
							</td>
						</tr>
			...
			<div id="contact" class="container" style="backgroun;">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<p><span class="glyphicon glyphicon-phone"></span>Phone: +91 9167320399</p>
