...
?>		<html>
			...
			<head>
				...
				<title>Order|Devivery Address</title>
								...
								<td>
									<?php
										...
										if($row = mysql_fetch_array($rs))
										{
											...
											if($sts==0)
											{
												echo "<h2 style='letter-spacing:9px'> Delivery Address </h2>";
											}
											
											else
											{
												echo "<font size='+3' color='red'> Opps!!! Sorry </font>";
											}
										}	
									?>
								</td>
									...
									if($row = mysql_fetch_array($rs))
									{
										...
										echo 	"<br>";
												...
												if($sts==0)
												{
													...
													<form action='order_summery' method='post' name='order_form' onsubmit='return err()'>
														...
														<div class='row'>
															...
															<div class='col-xs-6 form-group'>
																<label class='col-xs-8 control-label'> Select Currency Price: </label>
															</div>
														...
														<div class='row'>
															...
															<div class='col-sm-6 form-group'>
																<div id='iname'>
																	<input class='form-control' id='iname' name='name' placeholder='Full Name' type='text' value='' onkeypress='return onKeyValidate(event,alpha);' maxlength='40'>
																</div>	
															</div>
															
															<div class='col-sm-6 form-group'>
																<div id='iemail'>
																	<input class='form-control' id='iemail' name='email' placeholder='Email' type='email' value=''>
																</div>	
															</div>
														</div>	
														...
														<div class='row'>
															...
															<div class='col-sm-12 form-group'>
																<div id='iadd'>
																	<textarea name='add' class='form-control' placeholder='Address'></textarea>
																</div>	
															</div>
														...
														<div class='row'>
															...
															<div class='col-sm-6 form-group'>
																<div id='ict'>
																	<input class='form-control' id='ict' name='ct' placeholder='City' type='text' value='' onkeypress='return onKeyValidate(event,alpha);' maxlength='30'>
																</div>	
															</div>
														...
														<div class='row'>
															<div class='col-sm-6 form-group'>
																<div id='ist'>
																	<input class='form-control' id='ist' name='st' placeholder='State' type='text' value='' onkeypress='return onKeyValidate(event,alpha);' maxlength='30'>
																</div>
															</div>	
															
															<div class='col-sm-6 form-group'>
																<div id='ipc'>
																	<input class='form-control' id='ipc' name='pc' placeholder='Pin Code' type='text' value='' onkeypress='return onKeyValidate(event,numeric);' maxlength='15'>
																</div>	
															</div>
														...
														<div class='row'>
															...
															<div class='col-sm-6 form-group'>
																<input class='form-control' id='ilm' name='lm' placeholder='Landmark' type='text' value='' onkeypress='return onKeyValidate(event,alphanumeric);' maxlength='100'>
															</div>
															
															<div class='col-sm-6 form-group'>
																<div id='imbl'>
																	<input class='form-control' id='imbl' name='mbl' placeholder='Mobile N.' type='text' value=''>
																</div>	
															</div>
														...
														<div class='row'>  
															<div class='col-md-12 form-group'>
																<button class='btn pull-left' type='submit'>Next >></button>
