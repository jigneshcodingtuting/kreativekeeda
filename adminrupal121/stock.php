							...
							echo 	"<td>
											<div class='dropup'>
												...
												<ul role='menu' class='dropdown-menu dropdown-menu-right'>
													...
													<li><a href='availablestock?id=$row[0]' title='Click to Available this Painting'> Available</a></li>
													
													<li><a href='soldout?id=$row[0]' title='Click to Sold Out this Painting'> Sold Out </a></li>
													
													<li><a href='edit_stock?id=$row[0]' title='Edit'> Edit </a></li>
