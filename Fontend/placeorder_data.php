<?php session_start();
	...
	else
	{
		...
		if($row = mysql_fetch_array($rs1))
		{
			...
			{
				$sql = "INSERT INTO `orders` (`order`, `name`, `email`, `country`, `address`, `city`, `state`, `pin_code`, `landmark`, `mobile`, `order_price`, `date`, `time`) VALUES ( '$title', '$name', '$email', '$country', '$add', '$ct', '$st', '$pc', '$lm', '$mbl', '$price', '$date', '$time')";
