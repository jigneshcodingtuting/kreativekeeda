			...
			<div class="panel-heading" style="background: rgb(87, 39, 87) none repeat scroll 0% 0%;">
				<table>
					<tr>
						...
						<td>
							<h3 style="color:d5d5d5; letter-spacing:9px;">&nbsp;Stock</h3>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="panel-body">
				...
				<table class="table table-hover">
					...
					<?php
						...
						if(empty($_GET['sn']))
						{
							$sql = "select * from gallery limit 0, 15";
						}
						
						else
						{
							$sn=$_GET['sn'];
							$sql = "select * from gallery limit $sn, 15";
						}
						...
						while($row = mysql_fetch_array($rs))
						{
							...
							else
							{
								...
								echo "<td>".$row[0]."</td>";
								echo "<td>".$row[2]."</td>";
								echo "<td><img src='../img/gallery/".$row[1]."' height='50px' width='70px'></td>";
								echo "<td>".$row[3]."</td>";
							...
							echo 	"<td>
											<div class='dropup'>
												...
												<ul role='menu' class='dropdown-menu dropdown-menu-right'>";
													...
													if(isset($sn))
													{
														echo "<li><a href='availablestock?id=$row[0]&sn=$sn' title='Click to Available this Painting'> Available</a></li>";
													}
													
													else
													{
														echo "<li><a href='availablestock?id=$row[0]' title='Click to Available this Painting'> Available</a></li>";
													}
													
													if(isset($sn))
													{
														echo  "<li><a href='soldout?id=$row[0]&sn=$sn' title='Click to Sold Out this Painting'> Sold Out </a></li>";
													}
													
													else
													{
														echo  "<li><a href='soldout?id=$row[0]' title='Click to Sold Out this Painting'> Sold Out </a></li>";	
													}
													
													if(isset($sn))
													{
														echo "<li><a href='edit_stock?id=$row[0]&sn=$sn' title='Edit Info'> Edit info</a></li>";
													}
													
													else
													{
														echo "<li><a href='edit_stock?id=$row[0]' title='Edit Info'> Edit info</a></li>";
													}
													
												echo	"
														<li><a href='change_image?id=$row[0]' title='Change Image'> Change Image</a></li>
													
													<li role='presentation' class='divider'></li>
													<li><a href='delete_stock?id=$row[0]' title='Delete from Stock'> <font color='maroon'> Delete From Stock </font> </a></li>
												</ul>
											</div>
										</td>";
				...
				<center>
					<?php 
						...
						for($i=0;$i<$cid;$i=$i+15)
						{
							echo "<a href='stock?sn=$i'>$j</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
							$j++;
						}
