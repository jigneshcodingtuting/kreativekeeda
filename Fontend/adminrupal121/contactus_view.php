			...
			<div class="panel-heading" style="background: rgb(87, 39, 87) none repeat scroll 0% 0%;">
				<table>
					<tr>
						...
						<td>
							<h3 style="color:d5d5d5; letter-spacing:9px;">&nbsp;Visitor's Inquiry</h3>
						</td>
					</tr>
				</table>
			</div>
							...
							echo 	"<td>
											<div class='dropup'>
												...
												<ul role='menu' class='dropdown-menu dropdown-menu-right'>
													<li><a href='checked?id=$row[0]' title='Checked'> Checked <br><br><br></a></li>
													<li role='presentation' class='divider'></li>
													<li><a href='delete_contactus?id=$row[0]' title='Delete Record'> <font color='maroon'> Delete Record </font> </a></li>
												</ul>
											</div>
										</td>";
